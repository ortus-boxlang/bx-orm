...
- `SessionFactoryBuilder` If for some reason the session factory failed to build, wipe the bootstrap registry to avoid leaks
...
[unreleased]: https://github.com/ortus-boxlang/bx-orm/compare/v1.4.1...HEAD
